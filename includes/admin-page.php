...
function spsn_admin_page() {
    ...
    <div class="wrap">
        <h3><strong>This is the admin page for share blog post with facebook friends. This plugin is installed correctly. For additional information, please visit</h3>
    </div>
